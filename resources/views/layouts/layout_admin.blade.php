    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a style="background:#139c40" href="{{route('client.accueil')}}" class="brand-link">
                <img src="{{ asset('template/admin/dist/img/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .3">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('template/admin/dist/img/logo.png')}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">PGC-UVCI</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"><a href="{{route('admin.validation.partenaire')}}" class="nav-link"><i style="font-size:13px" class="fa fa-users nav-icon"></i>
                                <p>Partenaires</p>
                            </a></li>
                        ...
                        <li class="nav-item"><a href="{{ url($menu->url) }}" class="nav-link"><i style="font-size:13px" class="far fa-circle nav-icon"></i>
                                <p>{{ $menu->title }}</p>
                            </a></li>
                        @endforeach
                        @endif
            ...
            <footer style="background:#951b81; color:#fff; height:50px" class="main-footer">
                <div class="col-xs-12">
                    <div style="text-align:center" class="copyright-content">
                        <p>Copyright © 2020 -- UVCI tous droits réservés. <i class="fa fa-copyright" aria-hidden="true"></i>
        ...
        <!-- Scripts DataTable -->
        <link rel="stylesheet" type="text/css" href="{{ asset('datatable/datatables.net-bs4/css/dataTables.bootstrap4.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('datatable/datatables.net-bs4/css/responsive.dataTables.min.css') }}">
        <!-- This is data table -->
