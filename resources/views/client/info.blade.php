                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="user-profile">
                                                            ...
                                                            <img src="{{asset('/docs/images/lms/'.$partenaireWithMoyenActivite->image_convention)}}"
                                                                alt="profile-img"
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <h3 class="d-inline-block">
                                                                <img src="{{asset('/docs/images/lms/'.$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->logo)}}"
                                                                    alt="profile-img"
                                                                    class="rounded-pill avatar-130 img-fluid">
                                                            </h3>
                                                        </div>
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <p class="d-inline-block pl-3"> <a
                                                                    href="{{asset('/docs/images/lms/'.$partenaireWithMoyenActivite->file_convention)}}"
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <br>
                                                            <p class="d-inline-block pl-3"> <a
                                                                    href="{{asset('/docs/images/lms/'.$partenaireWithMoyenActivite->regime)}}"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$categorie->where('id' , $partenaireWithMoyenActivite->categorie_id)->first()->libelle_categorie}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">Contact:</h6>
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->contact_tel}}<a
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->continent}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->pays}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->ville}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->status}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->site}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->libelle_structure}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->nom}}<a
                                                                href="#" class="text-body"></a></p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">Nom du point focal:
                                                        </h6>
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->prenoms}}<a
                                                                href="#" class="text-body"></a></p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">Email:
                                                        </h6>
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->email}}<a
                                                                href="#" class="text-body"></a></p>
                                                    </div>
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->situation_geo}}<a
                                                                href="#" class="text-body"></a></p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">Motif:
                                                        </h6>
                                                        <p>{{$demande->where('id' , $partenaireWithMoyenActivite->partenariat_id)->first()->motif}}<a
                                                                href="#" class="text-body"></a></p>
                                                    </div>
                                                </div>
                                            </div>
