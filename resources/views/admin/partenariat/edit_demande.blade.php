                        ...
                        <div class="card-body" style="font-size:1.3rem; margin-left:15px">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('/docs/images/lms/'.$demande_attente->logo)}}" class="img-fluid" style="width:20%" height="30%" alt="">
                                        @else
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <h6>
                                            <a href="{{asset('/docs/images/lms/'.$demande_attente->exemple_convention)}}" target="_blank"><span>Convention</span>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <h6>
                                            <a href="{{asset('/docs/images/lms/'.$demande_attente->regime)}}" target="_blank"><span>Registre de commerce</span>
                                                <i class="fa fa-download" aria-hidden="true"></i></a>
                                        </h6>
                                        @else
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="continent" value="{{$demande_attente->continent}}">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>pays</label>
                                        <input type="text" class="form-control" name="pays" value="{{$demande_attente->pays}}" placeholder="">
                                    </div>
                                </div>
                                ...
                                i <div class="col-4">
                                    <div class="form-group">
                                        <label>Ville</label>
                                        <input type="text" class="form-control" name="ville" value="{{$demande_attente->ville}}" placeholder="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <input type="text" class="form-control" name="status" value="{{$demande_attente->status}}">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>décret</label>
                                        <input type="text" class="form-control" name="decret" value="{{$demande_attente->decret}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="site" value="{{$demande_attente->site}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="prenoms" value="{{$demande_attente->prenoms}}">
                                    </div>
                                </div>
                            </div>
