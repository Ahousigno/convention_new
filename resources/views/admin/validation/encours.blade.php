                            ...
                            <table id="config-table" class="table">
                                ...
                                <tbody id='content'>
                                    ...
                                    <tr style="font-size:13px">
                                        ...
                                        <td style="font-size:1.3rem">{{$partenaire->libelle_structure}}</td>
                                        <td>
                                            <span style="color : blue"><i style="font-size : 18px" class="fa fa-cog fa-spin fa-3x fa-fw "></i> validation en
                                                cours...</span>
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <div class="modal fade bd-example-modal-lg" id="valider{{$partenaire->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                ...
                                                <form action="{{route('validation_partner', [$partenaire->id])}}" method="post" enctype='multipart/form-data'>
                                                    ...
                                                    <div class="row col-lg-12" style="margin-bottom:25px">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <input type="text" name="nom_convention" id="" class="form-control">
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="row col-lg-12">
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Charger la convention signée</label>
                                                            <input type="file" name="file_convention" id="" class="form-control">
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Charger une image de la signature</label>
                                                            <input type="file" name="image_convention" id="" class="form-control">
                                                        </div>
                                                    </div>
...
<script>
    document.getElementById('date_debut').addEventListener('change', calculateEndDate);
    document.getElementById('duree').addEventListener('change', calculateEndDate);
    ...
    function calculateEndDate() {
        ...
        if (dateDebut && duree) {
            ...
            dateDebutObj.setFullYear(dateDebutObj.getFullYear() + duree);

            var dateFin = dateDebutObj.toISOString().split('T')[0];
