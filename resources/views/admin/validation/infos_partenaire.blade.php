                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <br>
                                                            <p class="d-inline-block pl-3"> <a
                                                                    href="{{asset('/docs/images/lms/'.$partenaire->regime)}}"
                                                                    target="_blank"><span>regime</span>
                                                                    <i class="fa fa-download"
                                                                        aria-hidden="true"></i></a></p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->continent}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->pays}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->ville}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->status}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->site}}<a
                                                                href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
