                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="user-profile">
                                                            ...
                                                            <img src="{{asset('/docs/images/lms/'.$partenaire->image_convention)}}" alt="profile-img" class="rounded-pill avatar-130 img-fluid">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <br>
                                                        <div class="mt-3">
                                                            ...
                                                            <h3 class="d-inline-block">
                                                                <img src="{{asset('/docs/images/lms/'.$demande->where('id' , $partenaire->partenariat_id)->first()->logo)}}" alt="profile-img" class="rounded-pill avatar-130 img-fluid">
                                                            </h3>
                                                        </div>
                                                        <br>
                                                        <div class="mt-3">
                                                            ...
                                                            <br>
                                                            <p class="d-inline-block pl-3"> <a href="{{asset('/docs/images/lms/'.$partenaire->file_convention)}}" target="_blank"><span>Convention</span>
                                ...
                                <div class="col-sm-12">
                                    <div class="mt-2">
                                        ...
                                        <p> <a href="#" class="text-body">
                                                {{ Carbon::parse($partenaire->date_fin)->format('d-m-Y')}}</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-12 ">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p> <a href="#" class="text-body">
                                                                {{ Carbon::parse($partenaire->date_debut)->format('d-m-Y') }}</a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">Date de fin:</h6>
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->continent}}<a href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->pays}}<a href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">ville:
                                                        </h6>
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->ville}}<a href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="mt-2">
                                                        ...
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->status}}<a href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <h6 class="mb-1" style="font-weight:bold;">site:
                                                        </h6>
                                                        <p>{{$demande->where('id' , $partenaire->partenariat_id)->first()->site}}<a href="#" class="text-body"></a>
                                                        </p>
                                                    </div>
